   ...
   /* :-[ / :-@  */ rage: /:-?[\[@]/g,
         ...
         /* :-1: */ thumbsdown: /:\-1:/g
            ...
            function defaultReplacer(emoji, name) {
                ...
                if (elementType !== 'img') {
                    return "<" +  elementType +" ng-click='addEmoji(\":" + name + ":\")' class='emoji emoji-" + name + "' title=':" + name + ":'></" + elementType+ ">";
                } else {
                    return "<img align='absmiddle' ng-click='addEmoji(\":" + name + ":\")' alt=':" + name + ":' class='emoji' src='" + this.config.img_dir + '/' + name + ".png' title=':" + name + ":' />";
                }
            }
